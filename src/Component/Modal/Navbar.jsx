        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <FontAwesomeIcon classNameName="font-white" icon={faStore} />
            </div>
            <div className="sm:ml-6 sm:block">
              <div className="flex space-x-4">
                <button className="text-white" onClick={openLoginModal}>
                  Login
                  <FontAwesomeIcon classNameName="icon-navbar" icon={faUser} />
                </button>
                ...
                <button className="text-white" onClick={openContactModal}>
                  Contact
